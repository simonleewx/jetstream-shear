...
fig, ((ax1, ax2), (ax3, ax4), (ax5,ax6)) = plt.subplots(3, 2, sharex='col', sharey=False,figsize=(7,10))
cpsize=2
# ERA
...
ax5.text(0, 1.022, 'b',verticalalignment='bottom', horizontalalignment='right',transform=ax5.transAxes,color='k', weight='bold')
...
ax6.text(0, 1.022, 'e',verticalalignment='bottom', horizontalalignment='right',transform=ax6.transAxes,color='k', weight='bold')
...
ax3.set_xlabel("trend (m s$^{-1}$ 100 hPa$^{-1}$ decade$^{-1}$)")
ax3.text(0, 1.022, 'c',verticalalignment='bottom', horizontalalignment='right',transform=ax3.transAxes,color='k', weight='bold')
...
ax4.set_xlabel("trend (m s$^{-1}$ decade$^{-1}$)")
ax4.text(0, 1.022, 'f',verticalalignment='bottom', horizontalalignment='right',transform=ax4.transAxes,color='k', weight='bold')
